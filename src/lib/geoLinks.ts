/**
 * Geographic proximity linking engine for Haute-Garonne (31).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (43.60°N for Toulouse)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(43.60°) ≈ 80.5 km
